...
// import DysonSphereRecipe from '../../components/DysonSphere/recipe'
import dynamic from 'next/dynamic'
// import PropTypes from 'prop-types'

const DysonSphereRecipe = dynamic(() => import('../../components/DysonSphere/recipe'), {
  ssr: false,
})

// export const config = { amp: true };

const DysonSphere = (props) => {
  // useEffect(() => {
  ...
  //   //   function (graph) {},
  //   // )
  //   configGraph(myChart, graphJSON)

  //   // option && myChart.setOption(option)
  // }, [])
  const configGraph = (myChart, graph) => {
    myChart.hideLoading()
...
// export const getServerSideProps = async ({ params, req, res, query, preview, previewData }) => { return { props: {}}}
// DysonSphere.getInitialProps = async ({ req }) => {}
DysonSphere.displayName = '📌 DysonSphere - PAGE'
